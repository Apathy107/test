  ...
  return (
    <div className="space-y-6">
          ...
          <TechCard title="资质过期未处理 TOP3" icon={ShieldCheck} className="h-full">
            <div className="space-y-3 pt-1">
              ...
              <div className="pt-1 text-center">
                <button type="button" className="text-xs text-primary hover:underline">查看全部过期名单 →</button>
              </div>
            </div>
          </TechCard>
        </div>
      ...
      <div className="flex gap-4">
        <div className="flex-1">
          <TechCard title="个人绩效卡片（TOP 飞手）" icon={Award} action={<button type="button" className="text-xs text-primary">查看全部 →</button>}>
